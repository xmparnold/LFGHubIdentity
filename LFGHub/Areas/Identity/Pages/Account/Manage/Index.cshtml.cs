...
namespace LFGHub.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(AdvanceUser user)
        {
            ...
            var destinyUsername = user.DestinyUsername;
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            user.DestinyUsername = Input.DestinyUsername;
